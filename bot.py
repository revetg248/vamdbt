...
admin_id = 986346230
# токен от бота
token = '1013723732:AAFsnDRnVVW0WrkSHkXM74xvt9TUYR54fHA'
#=====================
...
def faq_answer(message):
	try:
		if message.from_user.id == admin_id:
			bot.send_message(message.from_user.id, 'https://telegra.ph/Upravlenie-botom-cherez-admin-panel--komandy-12-07')
	except:
